# Copyright Colin O'Flynn 2013-2016
# www.NewAE.com
#
#
#
...
generateAllDiffs("reg_clockglitch/gc/DCM_extclock_gen2", "Glitch Width", "cw1200-glitchwidth.p", range(-127, 128))
generateAllDiffs("reg_clockglitch/gc/DCM_extclock_gen", "Glitch Offset", "cw1200-glitchoffset.p", range(-127, 128))
