...
#define _XPROG_PROTOCOL_
	...
	/* Macros: */
		...
		#define XPROG_GET_STATUS					 0x20
		#define XPROG_GET_RAMBUF					 0x21
		#define XPROG_SET_RAMBUF					 0x22
		...
		#define XPROG_PARAM_TIMEOUT                  0x08
	...
	/* Function Prototypes: */
		bool XPROGProtocol_Command(void);
			...
			static void XPROGProtocol_WriteMemory(uint8_t * buf);
			static void XPROGProtocol_ReadMemory(uint8_t * buf);
