...
if __name__ == '__main__':
    ...
    # baseline score
    program_reset()
    ret = capture_arm_cw.capture_all(N=24, Nt=10, seed=seed_dir, root=data_folder, device_id=1)
    if ret:
        sys.exit()
    # BiLSTM
    ...
    if ret:
        ...
        sys.exit()
    ret = capture_arm_cw.capture_all(N=num_paths, Nt=10, seed=seed_dir, root=data_folder, device_id=1)
    if ret:
